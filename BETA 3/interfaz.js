...
btnSumar.addEventListener("click", ()=>{
    let inputsDatos = document.querySelectorAll(".inputDato")
        ...
        document.querySelector(".valoresBinario").value = CPU.CambiarABinario(memoria)
        ...
        document.querySelector(".resultadoBinario").value = CPU.CambiarABinario(resultadoNormal)
