...
class Memoria{
    ...
    AgregarValor = (dato, registro) =>{
        ...
        if(!isNaN(dato)){
            ...
            this.memoria.set(this.contadorMemoria, {espacioMemoria: this.GenerarRandom(), valorPasado:dato})
            ...
            for (let i = 0; i < dato.length; i++) {
                this.contadorMemoria++
                this.memoria.set(this.contadorMemoria, {espacioMemoria: this.GenerarRandom(), valorPasado:dato[i]})
    ...
    MostrarMemoria = () =>{
        ...
        this.memoria.forEach((e)=>{
            memoriaCompleta.push(`En la Direccion de Memoria ${e.espacioMemoria}, esta el Dato: ${e.valorPasado}`)
        })
